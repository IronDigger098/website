...
<head>
    <title>Add New Non-Veg Item</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="main">
        <div class="back">
            <a href="{{ route('nonveg.index') }}">Back to Non-Veg Section</a>
        </div>
        <div class="form-container">
            <h2>Add New Non-Veg Item</h2>
            <form action="{{ route('nonveg.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
